...
def create_dispatcher() -> Dispatcher:
    ...
    dp.include_router(conversational_handlers.router)  # AI-powered handlers (/start, /list, text, media)
    dp.include_router(handlers.router)  # Additional commands (/webapp, /delete, /done)
